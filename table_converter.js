  ...
  Drupal.behaviors.table_converter = {
    attach: function(context, settings) {
      ...
      if (truncateDanger >= 1) {
        ...
        messageString += "Rows to be converted are shown in green. Primary keys will be truncated to 191 characters but you have no primary key values that are longer than that. <a href='/admin/config/system/tables/convert'>Convert All</a>";
      }
